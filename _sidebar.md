...
* [python初学问题总结](python初学问题总结.md)
    ...
    * [121. 买卖股票的最佳时机](1-200/121.买卖股票的最佳时机.md)
    ...
    * [146. LRU 缓存机制](1-200/146.LRU缓存机制.md)
    ...
    * [239.滑动窗口最大值](201-400/239.滑动窗口最大值.md)
    ...
    * [$266.回文排列.md](201-400/266.回文排列.md)
    ...
    * [$293.翻转游戏](201-400/293.翻转游戏.md)
    * [297. 二叉树的序列化与反序列化](201-400/297.二叉树的序列化与反序列化.md)
    * [299.猜数字游戏](201-400/299.猜数字游戏.md)
    * [300. 最长上升子序列](201-400/300.最长上升子序列.md)
    * [301. 删除无效的括号](201-400/301.删除无效的括号.md)
    * [303.区域和检索-数组不可变](201-400/303.区域和检索-数组不可变.md)
    * [304.二维区域和检索-矩阵不可变](201-400/304.二维区域和检索-矩阵不可变.md)
    * [309.最佳买卖股票时机含冷冻期](201-400/309.最佳买卖股票时机含冷冻期.md)
    * [312.戳气球](201-400/312.戳气球.md)
    * [318.最大单词长度乘积](201-400/318.最大单词长度乘积.md)
    * [319.灯泡开关](201-400/319.灯泡开关.md)
    * [322.零钱兑换](201-400/322.零钱兑换.md)
    * [$323.无向图中连通分量的数目](201-400/323.无向图中连通分量的数目.md)
    * [328. 奇偶链表](201-400/328.-qi-ou-lian-biao.md)
    * [335.路径交叉](201-400/335.路径交叉.md)
    * [337.打家劫舍III](201-400/337.打家劫舍III.md)
    * [338. 比特位计数](201-400/338.-bi-te-wei-ji-shu.md)
    * [$339.嵌套列表权重和](201-400/339.嵌套列表权重和.md)
    * [342.4的幂](201-400/342.4的幂.md)
    * [344. 反转字符串](201-400/344.-fan-zhuan-zi-fu-chuan.md)
    * [$346.数据流中的移动平均值](201-400/346.数据流中的移动平均值.md)
    ...
    * [475.供暖器](401-600/475.供暖器.md)
    * [476. 数字的补数](401-600/476.-shu-zi-de-bu-shu.md)
    * [$484.寻找排列](401-600/484.寻找排列.md)
    * [485. 最大连续1的个数](401-600/485.-zui-da-lian-xu-1-de-ge-shu.md)
    * [488.祖玛游戏](401-600/488.祖玛游戏.md)
    * [492.构造矩形](401-600/492.构造矩形.md)
    * [494.目标和](401-600/494.目标和.md)
    * [495.提莫攻击](401-600/495.提莫攻击.md)
    * [496. 下一个更大元素 I](401-600/496.-xia-yi-ge-geng-da-yuan-su-i.md)
    * [500. 键盘行](401-600/500.-jian-pan-hang.md)
    * [503.下一个更大元素II](401-600/503.下一个更大元素II.md)
    * [506.相对名次](401-600/506.相对名次.md)
    * [508.出现次数最多的子树元素和](401-600/508.出现次数最多的子树元素和.md)
    ...
    * [$531.孤独像素I.md](401-600/531.孤独像素I.md)
    * [537. 复数乘法](401-600/537.-fu-shu-cheng-fa.md)
    * [538.把二叉搜索树转换位累加树](401-600/538.把二叉搜索树转换位累加树.md)
    * [540. 有序数组中的单一元素](401-600/540.-you-xu-shu-zu-zhong-de-dan-yi-yuan-su.md)
    * [542.01矩阵](401-600/542.01矩阵.md)
    * [$544.输出比赛匹配对](401-600/544.输出比赛匹配对.md)
    ...
    * [630.课程表III](601-800/630.课程表III.md)
    ...
    * [652.寻找重复的子树](601-800/652.寻找重复的子树.md)
    * [653.两数之和IV-输入BST](601-800/653.两数之和IV-输入BST.md)
    ...
    * [686.重复叠加字符串匹配](601-800/686.重复叠加字符串匹配.md)
    ...
    * [743.网络延迟时间](601-800/743.网络延迟时间.md)
    ...
    * [$760.找出变位映射](601-800/760.找出变位映射.md)
    ...
    * [785.判断二分图](601-800/785.判断二分图.md)
    * [794.有效的井字游戏](601-800/794.有效的井字游戏.md)
    * [797.所有可能的路径](601-800/797.所有可能的路径.md)
    * [799.香槟塔](601-800/799.香槟塔.md)
    * 801~1000
    * [807.保持城市天际线](801-1000/807.保持城市天际线.md)
    * [817. 链表组件](801-1000/817.-lian-biao-zu-jian.md)
    * [845. 数组中的最长山脉](801-1000/845.-shu-zu-zhong-de-zui-chang-shan-mai.md)
    * [846.一手顺子](801-1000/846.一手顺子.md)
    * [851.喧闹和富有](801-1000/851.喧闹和富有.md)
    * [852.山脉数组的峰顶索引](801-1000/852.山脉数组的峰顶索引.md)
    * [859.亲密字符串](801-1000/859.亲密字符串.md)
    * [869.重新排序得到2的幂](801-1000/869.重新排序得到2的幂.md)
    * [876. 链表的中间结点](801-1000/876.-lian-biao-de-zhong-jian-jie-dian.md)
    * [886.可能的二分法](801-1000/886.可能的二分法.md)
    * [887.鸡蛋掉落](801-1000/887.鸡蛋掉落.md)
    * [911.在线选举](801-1000/911.在线选举.md)
    * [990.等式方程的可满足性](801-1000/990.等式方程的可满足性.md)
    * [997.找到小镇的法官](801-1000/997.找到小镇的法官.md)
    * 1000~2000
    * [1002.查找常用字符](1001-2000/1002.-cha-zhao-chang-yong-zi-fu.md)
    * [1005.K次取反后最大化的数组和](1001-2000/1005.K次取反后最大化的数组和.md)
    * [1009.十进制整数的反码](1001-2000/1009.十进制整数的反码.md)
    * [1014. 最佳观光组合](1001-2000/1014.-zui-jia-guan-guang-zu-he.md)
    * [1034.边界着色](1001-2000/1034.边界着色.md)
    * [1038.把二叉搜索树转换为累加树](1001-2000/1038.把二叉搜索树转换为累加树.md)
    * [1078.Bigram分词](1001-2000/1078.Bigram分词.md)
    * [1094.拼车](1001-2000/1094.拼车.md)
    * [1109.航班预订统计](1001-2000/1109.航班预订统计.md)
    * [$1135.最低成本联通所有城市](1001-2000/1135.最低成本联通所有城市.md)
    * [1143.最长公共子序列](1001-2000/1143.最长公共子序列.md)
    * [1154.一年中的第几天](1001-20001154.一年中的第几天.md)
    * [1218.最长定差子序列](1001-2000/1218.最长定差子序列.md)
    * [1254. 统计封闭岛屿的数目](1001-2000/1254.-tong-ji-feng-bi-dao-yu-de-shu-mu.md)
    * [1312.让字符串成为回文串的最少插入次数](1001-2000/1312.让字符串成为回文串的最少插入次数.md)
    * [1361.验证二叉树](1001-2000/1361.验证二叉树.md)
    * [1373.二叉搜索子树的最大键值和](1001-2000/1373.二叉搜索子树的最大键值和.md)
    * [1446.连续字符](1001-2000/1446.连续字符.md)
    * [1514.概率最大的路径](1001-2000/1514.概率最大的路径.md)
    * [1518.换酒问题](1001-2000/1518.换酒问题.md)
    * [1576.替换所有的问号](1001-20001576.替换所有的问号.md)
    * [$1584.连接所有点的最小费用](1001-2000/1584.连接所有点的最小费用.md)
    * [1610.可见点的最大数目](1001-2000/1610.可见点的最大数目.md)
    * [1614.括号的最大嵌套深度](1001-2000/1614.括号的最大嵌套深度.md)
    * [1631.最小体力消耗路径](1001-2000/1631.最小体力消耗路径.md)
    * [1679.K和数对的最大数目](1001-2000/1679.K和数对的最大数目.md)
    * [1774.最接近目标价格的甜点成本](1001-2000/1774.最接近目标价格的甜点成本.md)
    * [1816.截断句子](1001-2000/1816.截断句子.md)
    * [1854.人口最多的年份](1001-2000/1854.人口最多的年份.md)
    * [1909.删除一个元素使数组严格递增](1001-2000/1909.删除一个元素使数组严格递增.md)
    * [1952.三除数](1001-2000/1952.三除数.md)
    * 2001~3000
    * [2022.将一维数组转变成二维数组](2001-3000/2022.将一维数组转变成二维数组.md)
    * [2073.买票需要的时间](2001-3000/2073.买票需要的时间.md)
    * [2074.反转偶数长度组的节点](2001-3000/2074.反转偶数长度组的节点.md)
    * [2075.解码斜向换位密码](2001-3000/2075.解码斜向换位密码.md)
    * [2076.处理含限制条件的好友请求](2001-3000/2076.处理含限制条件的好友请求.md)
    * [2078.两栋颜色不同且距离最远的房子](2001-3000/2078.两栋颜色不同且距离最远的房子.md)
    * [2079.给植物浇水](2001-3000/2079.给植物浇水.md)
    * [2080.区间内查询数字的频率](2001-3000/2080.区间内查询数字的频率.md)
    * [2085.统计出现过一次的公共字符串](2001-3000/2085.统计出现过一次的公共字符串.md)
    * [2086.从房屋收集雨水需要的最少水桶数](2001-3000/2086.从房屋收集雨水需要的最少水桶数.md)
    * [2087.网格图中机器人回家的最小代价](2001-3000/2087.网格图中机器人回家的最小代价.md)
    * [2099.找到和最大的长度为K的子序列](2001-3000/2099.找到和最大的长度为K的子序列.md)
    * [2100.适合打劫银行的日子](2001-3000/2100.适合打劫银行的日子.md)
    * 其他
    * [乌龟跑步](牛客网/乌龟跑步.md)
    * [求最少的递减子序列个数及子序列](牛客网/求最少的递减子序列个数及子序列.md)
    * [dy一面笔试](其他/dy一面笔试.md)
    * [堆栈中的剩余数字](牛客网/堆栈中的剩余数字.md)
    * [向量平行](牛客网/向量平行.md)